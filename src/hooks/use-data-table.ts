...
import { type ExtendedColumnSort } from '@/lib/date-table/types'
...
export function useDataTable<TData>(props: UseDataTableProps<TData>) {
	...
	const table = useReactTable({
		...
		state: {
			...
			rowSelection,
			columnFilters,
			globalFilter: tableProps.enableGlobalFilter
				? globalFilterValue
				: undefined,
		},
		defaultColumn: {
		...
		enableGlobalFilter: tableProps.enableGlobalFilter,
		onRowSelectionChange: setRowSelection,
		onPaginationChange,
		onSortingChange,
		onColumnFiltersChange,
		onColumnVisibilityChange: setColumnVisibility,
		onGlobalFilterChange: tableProps.enableGlobalFilter
